...
export declare const ProductMasterCategoryInsertFields: {
    productId: import("@sinclair/typebox").TString;
    masterCategoryId: import("@sinclair/typebox").TString;
};
/** [Auto-Generated] Do not edit this tag to keep updates. @generated */
export declare const ProductMasterCategoryFields: {
    productId: import("@sinclair/typebox").TString;
    masterCategoryId: import("@sinclair/typebox").TString;
};
export declare const ProductMasterCategoryContract: {
    /** [Auto-Generated] Do not edit this tag to keep updates. @generated */
...
export type ProductMasterCategoryContract = InferDTO<typeof ProductMasterCategoryContract>;
