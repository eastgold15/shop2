...
export const MasterContract = {
  ...
  // 更新请求 (精细化可选更新)
  Update: t.Partial(
    t.Omit(t.Object(MasterBase.insertFields), [
      "id",
      "createdAt",
      "updatedAt",
      "siteId",
  ...
  // 列表查询
  ListQuery: t.Object({
    ...t.Partial(t.Object(MasterBase.insertFields)).properties,
  ...
  ListResponse: t.Object({
    data: t.Array(t.Object(MasterBase.fields)),
    total: t.Number(),
  }),
} as const;

// ✨ DTO 类型直接在此导出，方便外部引用
export type MasterDTO = InferDTO<typeof MasterContract>;
