...
export const VerificationInsertFields = spread(verificationTable, "insert");
/** [Auto-Generated] Do not edit this tag to keep updates. @generated */
export const VerificationFields = spread(verificationTable, "select");
export const VerificationContract = {
  ...
  ListResponse: t.Object({
    data: t.Array(t.Object({ ...VerificationFields })),
    total: t.Number(),
  }),
} as const;
