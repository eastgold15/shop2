    ...
    <div className="mx-auto max-w-4xl px-4 py-12 md:py-16">
          ...
          <header className="mb-12">
            ...
            <p className="mt-6 text-base text-gray-700 leading-relaxed">
              ...
              orders, shipping, or anything else, our team is ready to assist
              you.
            </p>
          </header>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed md:text-base">
                  ...
                  customization options? We are happy to provide detailed
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed md:text-base">
                  Need help with an existing order? Track your package, modify
                  your order, or inquire about delivery status. Please have your
                  order number ready.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed md:text-base">
                  Questions about international shipping, customs, duties, or
                  our return policy? Check our{" "}
                  <a
                    className="text-blue-600 underline hover:text-blue-800"
                    href="/single/ship"
                  >
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed md:text-base">
                  ...
                  competitive pricing for retailers and distributors. Contact us
                  for wholesale catalogs and pricing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed md:text-base">
                  Looking for custom designs, private label manufacturing, or
                  OEM services? Our team can help bring your footwear ideas to
                  life.
                </p>
              </div>
            </div>
          ...
          <section className="mb-12 border-gray-200 border-t pt-8">
            ...
            <p className="mb-4 text-gray-700 text-sm leading-relaxed md:text-base">
              Before reaching out, you might find quick answers in our FAQ
              section covering common questions about:
            </p>
          ...
          <section className="mb-12 border-gray-200 border-t pt-8">
            ...
            <ul className="mb-6 space-y-2 text-gray-700 text-sm md:text-base">
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>Phone/WhatsApp:</strong> Immediate during business
                  hours
                </span>
              </li>
              <li className="flex items-start">
