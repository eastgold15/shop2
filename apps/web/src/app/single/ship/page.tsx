  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 md:py-16">
      ...
      <section className="mb-12">
        ...
        <h3 className="mt-8 mb-4 font-semibold text-lg">Worldwide Delivery</h3>
        ...
        <div className="my-6 overflow-x-auto">
          <table className="min-w-full rounded-lg border border-gray-200 bg-white">
            ...
            <tbody>
              ...
              <tr className="border-b">
                <td className="px-4 py-3 text-gray-700 text-sm">DHL/FedEx</td>
                <td className="px-4 py-3 text-gray-700 text-sm">
                  3-7 business days
                </td>
                <td className="px-4 py-3 text-gray-700 text-sm">Yes</td>
      ...
      <section className="mb-12 border-gray-200 border-t pt-8">
        ...
        <p className="mb-4 text-gray-700 text-sm leading-relaxed md:text-base">
          ...
          of the recipient and are not included in the product price or shipping
          cost.
        </p>
        ...
        <ul className="mb-6 space-y-2 text-gray-700 text-sm md:text-base">
          ...
          <li className="flex items-start">
            <span className="mr-2">•</span>
            <span>Some countries have duty-free thresholds for imports</span>
          </li>
        </ul>
        ...
        <div className="my-6 rounded-lg bg-yellow-50 p-4">
          <p className="text-gray-700 text-sm">
            ...
            regulations before placing an order. Refusal to pay customs fees may
            result in package return or destruction.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12 border-gray-200 border-t pt-8">
        ...
        <h3 className="mt-8 mb-4 font-semibold text-lg">Return Conditions</h3>
        <p className="mb-4 text-gray-700 text-sm leading-relaxed md:text-base">
        ...
        <ul className="mb-6 space-y-2 text-gray-700 text-sm md:text-base">
          ...
          <li className="flex items-start">
            <span className="mr-2">•</span>
            <span>Refund processing time depends on your payment provider</span>
          </li>
        </ul>
